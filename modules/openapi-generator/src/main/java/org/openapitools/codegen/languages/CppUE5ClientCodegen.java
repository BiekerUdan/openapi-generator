...
public class CppUE5ClientCodegen extends AbstractCppCodegen {
    ...
    public static final String UNREAL_PLUGIN_NAME = "unrealPluginName";
    public static final String UNREAL_PLUGIN_NAME_DESC = "Name of the generated unreal plugin (optional)";
    public static final String OPTIONAL_PROJECT_FILE_DESC = "Generate Build.cs";

    protected String unrealModuleName = "OpenAPImodule";
    protected String unrealPluginName = "OpenAPIplugin";
    ...
    protected String cppNamespace = "OpenAPInamespace";
    @Setter protected boolean optionalProjectFileFlag = true;

    protected String pluginRootPath = "";
    protected String modulePath = "Source" + File.separator + unrealModuleName;
    protected String privatePath = modulePath + File.separator + "Private";
    protected String publicPath = modulePath + File.separator + "Public";

    public CppUE5ClientCodegen() {
        super();
        ...
        outputFolder = "generated-code/cpp-ue5";

        // set modelNamePrefix as default for cpp-ue5
         ...
         */
        embeddedTemplateDir = templateDir = "cpp-ue5";

        // CLI options
        addOption(CPP_NAMESPACE, CPP_NAMESPACE_DESC, this.cppNamespace);
        addOption(UNREAL_PLUGIN_NAME, UNREAL_PLUGIN_NAME_DESC, this.unrealPluginName);
        ...
        additionalProperties().put("unrealPluginName", unrealPluginName);
        ...
        updateSupportingFiles(optionalProjectFileFlag);
    ...
    public void processOpts() {
        ...
        if (additionalProperties.containsKey("unrealPluginName")) {
            unrealPluginName = (String) additionalProperties.get("unrealPluginName");
            updateSupportingFiles = true;
        }
    ...
    private void updateSupportingFiles(boolean optionalProjectFileFlag){
        // Direct output - no Plugins prefix
        pluginRootPath = "";
        modulePath = "Source" + File.separator + unrealModuleName;
        privatePath = modulePath + File.separator + "Private";
        publicPath = modulePath + File.separator + "Public";
        ...
        supportingFiles.add(new SupportingFile("uplugin.mustache", pluginRootPath, unrealPluginName + ".uplugin"));
        supportingFiles.add(new SupportingFile("model-base-header.mustache", publicPath, modelNamePrefix + "BaseModel.h"));
        supportingFiles.add(new SupportingFile("model-base-source.mustache", privatePath, modelNamePrefix + "BaseModel.cpp"));
        supportingFiles.add(new SupportingFile("helpers-header.mustache", publicPath, modelNamePrefix + "Helpers.h"));
        supportingFiles.add(new SupportingFile("helpers-source.mustache", privatePath, modelNamePrefix + "Helpers.cpp"));
        if (optionalProjectFileFlag) {
            supportingFiles.add(new SupportingFile("Build.cs.mustache", modulePath, unrealModuleName + ".Build.cs"));
            supportingFiles.add(new SupportingFile("module-header.mustache", privatePath, unrealModuleName + "Module.h"));
            supportingFiles.add(new SupportingFile("module-source.mustache", privatePath, unrealModuleName + "Module.cpp"));
        }
    ...
    public void postProcessModelProperty(CodegenModel model, CodegenProperty property) {
        ...
        // Mark int64 fields for special JSON parsing to avoid precision loss
        if ("int64".equals(property.dataType)) {
            property.vendorExtensions.put("x-cpp-int64", true);
        }
    }
    ...
    public String getHelp() {
        return "Generates a Unreal Engine 5.6+ C++ Plugin (beta). Requires UE 5.6 or later.";
    }
